...
host_alias=x86_64-apple-darwin17.0.0
host_vendor=apple
host_os=darwin17.0.0
host=x86_64-apple-darwin17.0.0
target_alias=x86_64-apple-darwin17.0.0
target_vendor=apple
...
prefix = /usr/local/Cellar/gomp/5.0
exec_prefix = ${prefix}
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --enable-libada --enable-libssp --enable-libvtv --enable-libmpx --enable-libhsail-rt --enable-liboffloadmic=host --enable-gold=yes --enable-ld=yes --enable-libquadmath=yes --enable-lto --enable-objc-gc --enable-vtable-verify --enable-werror --enable-host-shared --prefix=/usr/local/Cellar/gomp/5.0

tooldir = ${exec_prefix}/x86_64-apple-darwin17.0.0
build_tooldir = ${exec_prefix}/x86_64-apple-darwin17.0.0
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--enable-libada' '--enable-libssp' '--enable-libvtv' '--enable-libmpx' '--enable-libhsail-rt' '--enable-liboffloadmic=host' '--enable-gold=yes' '--enable-ld=yes' '--enable-libquadmath=yes' '--enable-lto' '--enable-objc-gc' '--enable-vtable-verify' '--enable-werror' '--enable-host-shared' '--prefix=/usr/local/Cellar/gomp/5.0' '--enable-languages=c,c++,fortran,lto,objc' --program-transform-name='s,y,y,' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty zlib libbacktrace libcpp libdecnumber fixincludes gcc libcc1
TARGET_CONFIGDIRS =  libgcc libbacktrace libgomp libcilkrts libatomic libitm libstdc++-v3 libsanitizer libvtv libmpx libssp libquadmath libgfortran libobjc
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  '--enable-libada' '--enable-libssp' '--enable-libvtv' '--enable-libmpx' '--enable-libhsail-rt' '--enable-liboffloadmic=host' '--enable-gold=yes' '--enable-ld=yes' '--enable-libquadmath=yes' '--enable-lto' '--enable-objc-gc' '--enable-vtable-verify' '--enable-werror' '--enable-host-shared' '--prefix=/usr/local/Cellar/gomp/5.0' '--enable-languages=c,c++,fortran,lto,objc' --program-transform-name='s,y,y,' --disable-option-checking
# Host programs are put under this directory, which is . except if building
# with srcdir=..
HOST_SUBDIR = host-x86_64-apple-darwin17.0.0
# This is the list of variables to export in the environment when
...
TARGET_SUBDIR = x86_64-apple-darwin17.0.0
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--enable-libada' '--enable-libssp' '--enable-libvtv' '--enable-libmpx' '--enable-libhsail-rt' '--enable-liboffloadmic=host' '--enable-gold=yes' '--enable-ld=yes' '--enable-libquadmath=yes' '--enable-lto' '--enable-objc-gc' '--enable-vtable-verify' '--enable-werror' '--enable-host-shared' '--prefix=/usr/local/Cellar/gomp/5.0' '--enable-languages=c,c++,fortran,lto,objc' --program-transform-name='s,y,y,' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AS_FOR_BUILD = $(AS)
CC_FOR_BUILD = $(CC)
CFLAGS_FOR_BUILD = -fomit-frame-pointer -funroll-loops  -ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast -mmmx -msse -flto -maes -march=native   
CXXFLAGS_FOR_BUILD = -g -O2
CXX_FOR_BUILD = $(CXX)
DLLTOOL_FOR_BUILD = $(DLLTOOL)
GFORTRAN_FOR_BUILD = $(GFORTRAN)
GOC_FOR_BUILD = $(GOC)
LDFLAGS_FOR_BUILD = -L/usr/local/opt/libkml/lib -L/usr/local/opt/openmp/lib -L/usr/local/opt/opencl/lib -L/usr/local/opt/valgrind/lib -L/usr/local/opt/suite-sparse/lib -L/usr/local/opt/tbb/lib -L/usr/local/opt/grt/lib -L/usr/local/opt/bison/lib -L/usr/local/opt/gettext/lib -L/usr/local/opt/zlib/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/openssl@1.1/lib -L/usr/local/opt/sqlite/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/lapack/lib -L/usr/local/opt/open-mpi/lib -L/usr/local/opt/binutils/lib -L/usr/local/opt/boost-python/lib -L/usr/local/opt/boost-mpi/lib -L/usr/local/opt/boost/lib -L/usr/local/opt/llvm/lib -L/opt/X11/lib -L/usr/local/Cellar/gcc/7.2.0/lib/gcc/7  -L/usr/local/cuda/lib -L/usr/local/cuda/nvvm/lib 
LD_FOR_BUILD = $(LD)
NM_FOR_BUILD = $(NM)
...
LDFLAGS = -L/usr/local/opt/libkml/lib -L/usr/local/opt/openmp/lib -L/usr/local/opt/opencl/lib -L/usr/local/opt/valgrind/lib -L/usr/local/opt/suite-sparse/lib -L/usr/local/opt/tbb/lib -L/usr/local/opt/grt/lib -L/usr/local/opt/bison/lib -L/usr/local/opt/gettext/lib -L/usr/local/opt/zlib/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/openssl@1.1/lib -L/usr/local/opt/sqlite/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/lapack/lib -L/usr/local/opt/open-mpi/lib -L/usr/local/opt/binutils/lib -L/usr/local/opt/boost-python/lib -L/usr/local/opt/boost-mpi/lib -L/usr/local/opt/boost/lib -L/usr/local/opt/llvm/lib -L/opt/X11/lib -L/usr/local/Cellar/gcc/7.2.0/lib/gcc/7  -L/usr/local/cuda/lib -L/usr/local/cuda/nvvm/lib 
LIBCFLAGS = $(CFLAGS)
CXXFLAGS = -g -O2
...
CFLAGS_FOR_TARGET = -g -O2 -fomit-frame-pointer -funroll-loops  -ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast -mmmx -msse -flto -maes -march=native   
